...
main_menu.add(
    ...
    types.InlineKeyboardButton(text='👾 Поддержка', callback_data='podder')
)
main_menu.add(
...
# Admin menu
admain_menu_ad = types.InlineKeyboardMarkup(row_width=3)
...
admain_menu_ad.add(
    types.InlineKeyboardButton(text='👥 Adminos', callback_data='ad'),
)
